<div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
  ...
  <div class="grid gap-5 mb-8 md:grid-cols-2 lg:grid-cols-3">
    <div class="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{$title1}}</h6>
    ...
    <div class="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{$title2}}</h6>
      <p class="text-sm text-gray-900">
        {{$paragraph2}}
      </p>
    </div>
    <div class="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{$title3}}</h6>
      <p class="text-sm text-gray-900">
        {{$paragraph3}}
      </p>
    </div>
    <div class="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{$title4}}</h6>
      <p class="text-sm text-gray-900">
        {{$paragraph4}}
      </p>
    </div>
    <div class="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{$title5}}</h6>
      <p class="text-sm text-gray-900">
        {{$paragraph5}}
    </div>
    <div class="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
      ...
      <h6 class="mb-2 font-semibold leading-5">{{$title6}}</h6>
      <p class="text-sm text-gray-900">
        {{$paragraph6}}
      </p>
    </div>
